...
const SkillBar = ({ label, level }) => {
  return (
    <div className="overflow-x-hidden">
      <p className="text-xs sm:text-sm uppercase font-medium text-gray-500">{label}</p>
      <span className="w-full h-1 sm:h-2 bgOpacity rounded-md inline-flex mt-1 sm:mt-2">
        ...
        >
          <span className="absolute -top-5 right-0 text-xs sm:text-sm text-black dark:text-white">{level}</span>
        </motion.span>
      </span>
    </div>
  );
      ...
      >
        ...
        <div className="w-full lgl:w-1/2">
          <div className="py-6 sm:py-12 font-titleFont flex flex-col gap-2 sm:gap-4">
            <h2 className="text-xl sm:text-2xl md:text-4xl font-bold text-black dark:text-white">Programming Skills</h2>
          </div>
        ...
        <div className="w-full lgl:w-1/2">
          <div className="py-6 sm:py-12 font-titleFont flex flex-col gap-2 sm:gap-4">
            <h2 className="text-xl sm:text-2xl md:text-4xl font-bold text-black dark:text-white">Development Skills</h2>
          </div>
          <div className="mt-2 sm:mt-4 w-full flex flex-col gap-4 sm:gap-6">
...
Database Skills</h2>
        ...
        <div className="w-full lgl:w-1/2">
          <div className="py-6 sm:py-12 font-titleFont flex flex-col gap-2 sm:gap-4">
            <h2 className="text-xl sm:text-2xl md:text-4xl font-bold text-black dark:text-white">Tools and Technologies</h2>
          </div>
          <div className="mt-2 sm:mt-4 w-full flex flex-col gap-4 sm:gap-6">
